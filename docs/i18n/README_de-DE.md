...
◆Ein im geteilten Modus gelesenes Dokument nimmt zwei dieser Zellen ein, nicht eine — Quelltext und Vorschau sind schon eine Teilung. Neben einem geteilten Dokument ist also Platz für zwei Bereiche und nicht für drei: ein dritter Platz wird erst gezeichnet, wenn der Leser die geteilte Ansicht verlässt.
